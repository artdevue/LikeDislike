...
$_lang['likedislike.desc'] = 'Управление голосованием за все, что угодно на вашем сайте.';
...
$_lang['likedislike.likedislik_err_login_required'] = 'Вы должны быть залогиненным для того, чтобы голосовать.';
...
$_lang['likedislike.management_desc'] = 'Управление голосованием за все, что угодно на вашем сайте. Вы можете редактировать их, путем редактирования голосования "Вверх" и "Down", дважды щелкнув на сетке двойным щелчком по соответствующей ячейки.<br/> Снизу даты публикации, указана <strong> категория </strong> (по умолчанию - class key resource) и через косую "/" - <strong>likeId</strong> (по умолчанию - id ресурса)'; 
...
$_lang['likedislike.search...'] = 'Поиск...';
$_lang['likedislike.ip_adress'] = 'IP адрес';
$_lang['likedislike.ip_block_create'] = 'Добавить IP';
$_lang['likedislike.loading'] = '<div class="centered empty-msg">Загрузка..</div>';
...
$_lang['setting_likedislike.defaultTemplate_desc'] = 'Формат по умолчанию будет использоваться для каждого шаблона.<br/>См. <a href="http://like.artdevue.com">документацию</a> для более подробное объяснение.';
...
$_lang['setting_likedislike.cookiePath_desc'] = 'Путь на сервере, в которой куки будут доступны.<br/> Если установлено в "/", куки будут доступны для всего домена<br/>. См.: <a target="_blank" href="http://php.net/manual/function.setcookie.php">http://php.net/manual/function.setcookie.php</a>';
...
$_lang['setting_likedislike.userLoginRequired_desc'] = 'Если установлено значение ДА, пользователь должн войти в для того, чтобы голосовать.<br/> Гости, не смогут участвовать в голосовании.';
